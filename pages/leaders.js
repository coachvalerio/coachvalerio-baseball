...
const BATTING_BOARDS = [
  ...
  { key: 'wrc_plus',            label: 'WEIGHTED RUNS',   abbr: 'wRC+', savant: true },
  { key: 'batter_war',          label: 'WINS ABV REPL.',  abbr: 'WAR',  savant: true },
];
...
const PITCHING_BOARDS = [
  ...
  { key: 'fip',                           label: 'FIELDING IND. P',  abbr: 'FIP',  savant: true },
  { key: 'pitcher_war',                   label: 'WINS ABV REPL.',   abbr: 'WAR',  savant: true },
];
